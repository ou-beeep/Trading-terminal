...
export function generateMetadata(): Metadata {
  ...
  return {
    title: process.env.NEXT_PUBLIC_DERIV_APP_NAME?.trim() || 'Deriv Trading Terminal',
    description: 'A white-label trading application powered by Deriv — Rise/Fall, Digits, and Accumulators',
