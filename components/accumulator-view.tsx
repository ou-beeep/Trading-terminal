...
import { TradeControls } from './trade-controls-accumulators';
...
import type { AccumulatorsAppConfig } from '../lib/app-config-accumulators';
...
export interface AccumulatorViewProps {
  ...
  /** Extra controls rendered in the header, next to the theme toggle (e.g. the market switcher). */
  ...
  const headerEl = useMemo(() => {
    ...
    return (
      <Header
        ...
        actions={<>{headerActions}<ThemeToggle /></>}
      />
    );
  }, [
    authState,
